...
To sync with the latest template improvements:

```bash
# One-time setup
git remote add upstream git@github.com:sanctusgee/advent-of-code-rust-template.git

# Regular updates eg on new template releases
git fetch upstream
